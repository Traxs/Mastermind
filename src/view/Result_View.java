...
public class Result_View extends JComponent
{
    ...
    private static final BufferedImage RESULTHOLE = Mastermind_File
            .loadImage("resulthole.png");

    /** The Constant RESULTWHITE. */
    private static final BufferedImage RESULTWHITE = Mastermind_File
            .loadImage("resultwhite.png");

    /** The Constant RESULTRED. */
    private static final BufferedImage RESULTRED = Mastermind_File
            .loadImage("resultred.png");
