...
/**
 * The Class KI is used to play against the computer, getting a tipp to play
 * with or for complete assistent function.
 * 
 * @author Birk Kauer
...
public class KI
{
    ...
    /**
     * Checks if the current parameter is in the SecretCode-sets which were
     * calculated by previous Inputs.
     * 
     * @param code
     *            the Input Code to check.
     */
     ...
     * 
     * @throws InterruptKIException
     *             will throw the Exception when the KI is forced to stop while
     *             calculating.
    ...
    private void calculatePossibilities() throws InterruptKIException
    {
        ...
        for (; rowCal < rowArray.length; rowCal++)
        {
            ...
            arrayList =
                    intersectSetCodeArrayList(arrayList,
     ...
     * @see mastermind.InterruptKIException
     */
    private ArrayList<Integer[]> intersectSetCodeArrayList(
            ArrayList<Integer[]> p1, ArrayList<Integer[]> p2)
            throws InterruptKIException
    {
    ...
    /**
     * Returns the highest probability of the secret code based on previous
     * inputs.
     * 
    ...
    /**
     * Returns a Set of SecretCode-set which is based on the codeinput and the
     * result of red and white pins of the parameter row.
     * 
     * @param row
     *            the row which includes the codeinput and the result which will
     *            generates a secretcode-set.
    ...
    private ArrayList<Integer[]> getPossibilities(Row row)
    {
        ...
        do
        {
            ...
            arrayList.add(SetCode.createRow(permutation, colorLength,
                    stoneCodes));
        }
        while (nextPermutation(permutation));// Repeat until there is no more
                                             // Permutation left
     ...
     * @param permutation
     *            the permutation.
     * @return will deliver true if there is another permutation otherwise
     *         false.
     */
    ...
    /**
     * This Method will be used by the nextPermutation Method. Delivers the
     * position of the next increased number of the intervall
     * [low,array.length].
     * 
     * @param The
     *            array which the method will look into.
     * @param low
     *            the lower border of the array.
    ...
    /**
     * will sort the array inside of the intervall [low, high] by using quick
     * sort.
     * 
     * @param array
     *            array to be sorted.
     * @param low
     *            lower border of the intervall.
     * @param high
     *            upper border of the intervall.
     */
