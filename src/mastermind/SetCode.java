...
/**
 * The Class SetCode is a help-class for handle the Integer-Sets and
 * SecretCode-set
 * 
 * @author Birk Kauer
...
public class SetCode
{
    ...
    /** The Constant setAll. */
    private static final int[] setAll =
     ...
     */
    public static Integer[] createRow(int[] resultCodes, int colorLength,
            int[] stoneCodes)
    {
        ...
        for (int i = 0; i < resultCodes.length; i++)
        {
            ...
            setCodes[i] =
                    resultCodes[i] == ResultCode.RED ? set[stoneCodes[i]]
     ...
     * 
     * @param set1
     *            first SecretCode-set.
     * @param set2
     *            second SecretCode-set.
    ...
    public static Integer[] intersectRow(Integer[] set1, Integer[] set2)
    {
        ...
        int newSet;
        // Union of the two elements from the Secret-Code set(Integer[]) column
        // by column
     ...
     * @param set
     *            set.
     * @return returns the first element of the set. If it's empty it will
     *         return -1.
     */
